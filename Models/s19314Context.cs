...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasKey(e => e.IdPracown)
                    .HasName("Pracownik_pk");

                entity.Property(e => e.IdPracown).ValueGeneratedNever();
            ...
            {
                entity.HasKey(e => e.IdWyrobCukierniczego)
                    .HasName("WyrobCukierniczy_pk");

                entity.Property(e => e.IdWyrobCukierniczego).ValueGeneratedNever();
            ...
            modelBuilder.Entity<Zamowienie>(entity =>
            {
                ...
                entity.Property(e => e.PracownikIdPracown).HasColumnName("Pracownik_IdPracown");
                ...
                entity.HasOne(d => d.PracownikIdPracownNavigation)
                    .WithMany(p => p.Zamowienie)
                    .HasForeignKey(d => d.PracownikIdPracown)
                    .OnDelete(DeleteBehavior.ClientSetNull)
            ...
            {
                entity.HasKey(e => new { e.IdZamowenia, e.IdWyrobCukierniczego })
                ...
                entity.HasOne(d => d.IdWyrobCukierniczegoNavigation)
                    .WithMany(p => p.ZamowienieWyrobCukierniczy)
                    .HasForeignKey(d => d.IdWyrobCukierniczego)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("Zamowienie_WyrobCukierniczy_WyrobCukierniczy");

                entity.HasOne(d => d.IdZamoweniaNavigation)
                    .WithMany(p => p.ZamowienieWyrobCukierniczy)
                    .HasForeignKey(d => d.IdZamowenia)
                    .OnDelete(DeleteBehavior.ClientSetNull)
